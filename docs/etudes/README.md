...
| 2026-09-02 | [Retours du portage Go](2026-09-02-retours-du-portage-go.md) | Qu'un portage Go indépendant a-t-il mesuré qui déplace ce qui est écrit ici ? | Quatre constats : la largeur 32 pourrait être ce qui rend le regroupement nécessaire ; la sparsité couche 1 rapporte ~6 % et non ~15 % ; précalculer les `metAfter` du videau vaut 1 % et `level_solve` en pèse 83 % ; « les doubles sont chers » est faux (écart réel 1,54×). Rien d'ouvert ici |
