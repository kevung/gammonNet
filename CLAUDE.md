...
| **4** | Modèle propre au projet | T40–T42 | **Conditionnelle** — ne s'ouvre que si T11 infirme ou T35 plafonne |
...
- `PLAN.md` — le plan d'exécution : 21 fiches de tâches, chacune avec son critère d'acceptation.
