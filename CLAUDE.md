...
| **9** | Se situer face au moteur libre le plus fort publié | T92–T95 | **Ouverte et rendue le 2026-09-07** — devant aux deux profondeurs : +0,0322 ppg sur un million de parties sans arbitre, écart apparié −0,00682 au 0-ply et −0,00232 au 2-ply. **L'avance fond à 34 % avec la profondeur** : c'est ce fait, et non le signe, qui renforce T71. T95 ne s'ouvre pas — sa condition était un écart en notre défaveur. Elle **mesure, elle n'importe pas** : ni code, ni poids, ni corpus, ni professeur d'entraînement |
